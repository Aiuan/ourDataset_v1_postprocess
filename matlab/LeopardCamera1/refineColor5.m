function image_refineColor = refineColor5(img_rgb)
     ...
     if tmp>0.5
         ...
         rg=tmp/2-0.1;   gg=1-tmp+0.2;    bg=tmp/2-0.1;
         rb=-0.1;    gb=0.3;   bb=0.8;
         
     else
         rr=0.85;   gr=0.25;   br=-0.1;
         rg=tmp/2;   gg=1-tmp;    bg=tmp/2;
         rb=-0.1;    gb=0.3;   bb=0.8;
     end
     
     if G1>0.95
        % 亮度调节，1.3为亮度参数，如果不把绿色增益值减半那就不需要，但对于天空占比多比较红的加上效果会好点

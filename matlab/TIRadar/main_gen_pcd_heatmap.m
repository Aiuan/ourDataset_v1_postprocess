...
% ====================user's modify start=====================
outputFolder = "/media/ourDataset/preprocess/20211025_2/TIRadar";
radarFolder = "/mnt/DATASET/20211025_2/TIRadar/TI_Capture_17";
...
while (i_globalSubFrame < cnt_globalSubFrames)
    ...
    if SAVE_ON
        ...
        heatmap_path = fullfile(outputFolder, strcat(sprintf('%.3f', round(double(timestamp_radar)/1e6, 3)), ".heatmap.mat"));
